# threat_intel_report_parser_tool
Threat Intelligence IOC/TTP report parser and distributor

Python Files Included:
  -  env_tool_tester.py: environment tool tester; verifies all prerequisite installs are complete
  -  threat_intel_parser_tool_cli.py: CLI version of the parser tool
  -  threat_intel_parser_tool_gui.py: GUI version of the parser tool
...
Note: The GUI version of the tool is self-explanatory.
...
Pre-Requisites to using the threat intelligence parser:
  ...
  - Run the environment tool tester to verify all pre-requisites are installed before running the tool.
  - This will help verify the environment is all set for the tool to run without errors.
